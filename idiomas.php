		...
		<div class="container-fluid main-content" id="dashboard">	 
			<div class="row">
				...
				<div class="col-lg-11 col-md-12 col-sm-12 col-xs-12 dashboard-data">
								...
								<div class="d-flex justify-content-between w-100">
									<div class="d-flex flex-column align-text-center">
										<div class="d-flex">
											...
											<h4 class='titulos3'><strong>Ingles</strong></h4>
										</div>
										<p class="parrafos">Estas cursando el <strong class="text-dark"> nivel 1 </strong></p>	
									</div>
									<div class="botoneschicos mt-2">
										<a href="#" class="text-reset calendario"><i data-feather="chevron-right"></i></a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="d-flex">
								<div class="d-flex justify-content-between w-100 ">
									<div class="d-flex flex-column align-text-center">
										<div class="d-flex">
											<img class="banderachica mr-3" src="./img/francia.jpeg"alt="">											
											<h4 class='titulos3'><strong>Frances</strong></h4>
										</div>
							...
							<div class="d-flex">
								<div class="d-flex justify-content-between w-100">
									<div class="d-flex flex-column align-text-center">
										<div class="d-flex">
											<img class="banderachica mr-3" src="./img/francia.jpeg"alt="">											
											<h4 class='titulos3'><strong>Italiano</strong></h4>
										</div>
										<p class="parrafos">Podes sumar este curso <strong class="text-dark"></strong></p>	
									</div>
									<div class="botoneschicos mt-2">
							...
							<div class="d-flex">
								<div class="d-flex justify-content-between w-100">
									<div class="d-flex flex-column align-text-center">
										<div class="d-flex">
											<img class="banderachica mr-3" src="./img/francia.jpeg"alt="">											
											<h4 class='titulos3'><strong>Aleman</strong></h4>
										</div>
										<p class="parrafos">Podes sumar este curso <strong class="text-dark"></strong></p>	
									</div>
									<div class="botoneschicos mt-2">
							...
							<div class="d-flex">
								<div class="d-flex justify-content-between w-100">
									<div class="d-flex flex-column align-text-center">
										<div class="d-flex">
											<img class="banderachica mr-3" src="./img/francia.jpeg"alt="">											
											<h4 class='titulos3'><strong>Portuges</strong></h4>
										</div>
										<p class="parrafos">Podes sumar este curso <strong class="text-dark"></strong></p>	
									</div>
									<div class="botoneschicos mt-2">
					...
					<!-- <div class="toolbar text-center progreso">
						...
						<div class="progreso-info mx-4">
							...
							<div class="py-3 mr-5 text-11 text-left achicarletra4 font-weight-bold">
							...
							<div class="border-bottom pagos disabled">
								<div class="border-bottom">
									<p class="text-left achicarletra4 info">Descripcion minima del nivel <br>
								...
								<div class="my-4 links">
									<a href="#" class="d-flex justify-content-center text-reset text-decoration-none">
										<img class="achicarPago" src="./img/credit-icon.png" alt=""> 
										<p class="ml-3 parrafoPago">Tarjeta <br> de credito</p>
									</a>
									<a href="#" class="d-flex justify-content-center my-3 text-reset text-decoration-none">
										<img class="achicarPago" src="./img/cash-icon.png" alt=""> 
										<p class="ml-3 parrafoPago">Efectivo <br> Pagofacil</p>
									</a>
									<a href="#" class="text-reset text-decoration-none">
										<img class="w-50" src="./img/mercado-pago.png" alt="">
									</a>
								</div>
							</div>  -->
